...
public class SelectPlayerState extends State{
    ...
    public SelectPlayerState(Game game) {
        ...
        players.add(new SelectingOption(game,Assets.playerWhite, Math.toRadians(225)));
        players.add(new SelectingOption(game,Assets.playerPurple, Math.toRadians(270)));
        players.add(new SelectingOption(game,Assets.playerGray, Math.toRadians(315)));
    }
